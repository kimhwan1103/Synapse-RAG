...
본 프로젝트는 크게 3가지 핵심 모듈로 구성되었다. 각 모듈의 상세 문서는 아래 링크를 참조한다.

### 1. 자체 구축한 하이브리드 지식 엔진 → [상세 문서](docs/custom_db.md)
...
### 2. Gardener: GNN-based Retriever → [상세 문서](docs/gardener.md)
...
### 3. Projector: Graph Adapter → [상세 문서](docs/inference_engine.md)
